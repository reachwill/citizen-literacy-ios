...
var VoicetitlePageModule = /** @class */ (function () {
    function VoicetitlePageModule() {
    }
...
var VoicetitlePage = /** @class */ (function () {
    function VoicetitlePage(speech, router) {
        this.speech = speech;
        this.router = router;
        this.responseList = [];
    ...
    VoicetitlePage.prototype.check = function () {
    ...
    VoicetitlePage.prototype.listen = function () {
        var _this = this;
        setTimeout(function () {
            this.stop();
        }, 5000);
        this.speech.startListening({ matches: 1 })
            .subscribe(function (matches) { _this.responseList = matches; }, function (onerror) { return console.log('error:', onerror); });
    };
    VoicetitlePage.prototype.stop = function () {
        this.speech.stopListening();
        setTimeout(this.getPermission, 1000);
        //console.log(this.responseList);
    };
    VoicetitlePage.prototype.getPermission = function () {
    ...
    VoicetitlePage.prototype.isSpeechSupported = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var isAvailable;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    VoicetitlePage.prototype.ngOnInit = function () {
    };
    VoicetitlePage.ctorParameters = function () { return [
...
//# sourceMappingURL=voicetitle-voicetitle-module-es5.js.map